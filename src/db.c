...
short gsn_first_aid;
short gsn_inoculate;
short gsn_loadinoculator;
short gsn_concentrate;
short gsn_mix;
short gsn_loremedicine;
short gsn_makemedpac;
short gsn_makeflamethrower;
short gsn_flamethrower;
short gsn_makejetpack;
short gsn_jetpackdodge;
short gsn_concussion_rocket;
short gsn_dark_frenzy;
short gsn_makeinoculator;
short gsn_makeshot;
short gsn_snipe;
short gsn_throw;
...
short gsn_doublelightsabers;
short gsn_spice_refining;
short gsn_makeblade;
short gsn_makevibrosword;
...
short gsn_saber_throwing;
short gsn_dagger_throwing;
short gsn_axe_throwing;
short gsn_spear_throwing;
short gsn_entangling_throw;
short gsn_telekinetic_throwing;
/* short gsn_flamethrowers; -- intentionally not ported, see mud.h note */
...
short gsn_duck;
short gsn_deadeye;
short gsn_appraiseitem;
short gsn_battlecry;
short gsn_spray;

/* v1.18 batch - social/passive Force skills */
short gsn_silvertongue;
short gsn_dipimmunity;
short gsn_maskaura;
...
short gsn_makedrinkcon;

/* v1.18 batch - engineering item skill */
short gsn_improved_concentration;
...
short gsn_chain_lightning;   /* v1.55 */
...
void boot_db( bool fCopyOver )
{
   ...
   /* Reserve a file handle so we can always open player files */
    ...
    */
   {
      ...
      ASSIGN_GSN( gsn_makevibrosword, "makevibrosword" );
      ...
      ASSIGN_GSN( gsn_embed_comlink, "embed_comlink" );
      ...
      ASSIGN_GSN( gsn_researchtarget, "researchtarget" );
      ASSIGN_GSN( gsn_revive, "revive" );
      ASSIGN_GSN( gsn_salvage, "salvage" );
      ASSIGN_GSN( gsn_seal, "seal" );
      ASSIGN_GSN( gsn_slide, "slide" );
      ASSIGN_GSN( gsn_trace_comlink, "trace_comlink" );
      ASSIGN_GSN( gsn_traps, "trap" );
      ...
      ASSIGN_GSN( gsn_loadinoculator, "loadinoculator" );
      ...
      ASSIGN_GSN( gsn_makeflamethrower, "make_flamethrower" );
      ASSIGN_GSN( gsn_flamethrower, "flamethrower" );
      ASSIGN_GSN( gsn_makejetpack, "make_jetpack" );
      ASSIGN_GSN( gsn_jetpackdodge, "jetpack_dodge" );
      ASSIGN_GSN( gsn_concussion_rocket, "concussion_rocket" );
      ASSIGN_GSN( gsn_dark_frenzy, "dark_frenzy" );
      ...
      ASSIGN_GSN( gsn_doublelightsaber_crafting, "double lightsaber crafting" );
      ASSIGN_GSN( gsn_doublelightsabers, "double lightsabers" );
      ...
      ASSIGN_GSN( gsn_vibro_swords, "vibro-swords" );
      ASSIGN_GSN( gsn_flexible_arms, "whips" );
      ASSIGN_GSN( gsn_talonous_arms, "claws" );
      ASSIGN_GSN( gsn_bludgeons, "bludgeons" );
      ASSIGN_GSN( gsn_vibro_axes, "vibro-axes" );

      /* Throwing specializations - ported from SWGD (v1.17) */
      ASSIGN_GSN( gsn_saber_throwing, "saber_throwing" );
      ASSIGN_GSN( gsn_dagger_throwing, "dagger_throwing" );
      ASSIGN_GSN( gsn_axe_throwing, "axe_throwing" );
      ASSIGN_GSN( gsn_spear_throwing, "spear_throwing" );
      ASSIGN_GSN( gsn_entangling_throw, "entangling_throw" );
      ASSIGN_GSN( gsn_telekinetic_throwing, "telekinetic_throwing" );
      /* ASSIGN_GSN( gsn_flamethrowers, "flamethrowers" ); -- intentionally
       * not ported; see mud.h note above gsn_flamethrowers declaration. */
      ...
      ASSIGN_GSN( gsn_deadeye, "deadeye" );
      ASSIGN_GSN( gsn_appraiseitem, "appraiseitem" );
      ASSIGN_GSN( gsn_battlecry, "battlecry" );
      ASSIGN_GSN( gsn_spray, "spray" );

      /* v1.18 batch - social/passive Force skills */
      ASSIGN_GSN( gsn_silvertongue, "silvertongue" );
      ASSIGN_GSN( gsn_dipimmunity, "diplomatic_immunity" );
      ASSIGN_GSN( gsn_maskaura, "maskaura" );
      ASSIGN_GSN( gsn_regeneration, "regeneration" );

      /* v1.18 batch - crafting recipes */
      ASSIGN_GSN( gsn_makeaxe, "makeaxe" );
      ASSIGN_GSN( gsn_makewhip, "makewhip" );
      ASSIGN_GSN( gsn_makebowcaster, "makebowcaster" );
      ASSIGN_GSN( gsn_makeforcepike, "makeforcepike" );
      ASSIGN_GSN( gsn_makedrinkcon, "makedrinkcon" );

      /* v1.18 batch - engineering item skill */
      ASSIGN_GSN( gsn_improved_concentration, "improved_concentration" );
      ...
      ASSIGN_GSN( gsn_chain_lightning, "chain lightning" );
...
OBJ_DATA *create_object( OBJ_INDEX_DATA * pObjIndex, int level )
{
   ...
   switch ( obj->item_type )
   {
      ...
      case ITEM_THREAD:
      /*
       * Ship modules - v1.19 fix. These were never given a case here at
       * all since the module system was built (v1.16), so create_object
       * has always hit the "bad type" default branch for every one of
       * them - it just never surfaced because no module items existed
       * anywhere in the game world until now. No special per-creation
       * logic needed; their behavior comes entirely from the Affect
       * list on pIndexData (see module_type_install/update_ship_modules
       * in space.c), same as makeblade's backstab bonus etc.
       */
...
void save_sysdata( SYSTEM_DATA sys )
{
   ...
   else
   {
      ...
      fprintf( fp, "Forcerollchance    %f\n", sys.force_roll_chance );
   ...
   for( ;; )
   {
      ...
      switch ( UPPER( word[0] ) )
      {
         ...
         case 'F':
            ...
            KEY( "Forcerollchance", sys->force_roll_chance, fread_float( fp ) );
            break;
